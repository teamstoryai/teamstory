...
config :teamstory, Teamstory.Repo,
  url: System.get_env("ECTO_URL") || "pg://localhost/teamstory_dev",
  stacktrace: true,
...
config :teamstory, serve_static: serve_static
...
config :teamstory, TeamstoryWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/teamstory_web/(live|views)/.*(ex)$",
      ~r"lib/teamstory_web/templates/.*(eex)$"
    ]
  ]
