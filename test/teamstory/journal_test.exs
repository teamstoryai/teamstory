defmodule Teamstory.JournalTest do
  use Teamstory.DataCase

  alias Teamstory.Journal

  describe "daily_notes" do
    alias Teamstory.Journal.DailyNote

    import Teamstory.JournalFixtures
  ...
  describe "streaks" do
    alias Teamstory.Journal.Streak
