defmodule TeamstoryWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :teamstory

  socket "/socket", TeamstoryWeb.UserSocket,
    websocket: [
      check_origin: false
    ]
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :teamstory
  end
  ...
  plug Stripe.WebhookPlug,
    at: "/webhook/stripe",
    handler: Teamstory.StripeHandler,
