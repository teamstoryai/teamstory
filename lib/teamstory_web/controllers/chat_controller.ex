defmodule TeamstoryWeb.ChatController do
  use TeamstoryWeb, :controller
  require Logger

  action_fallback TeamstoryWeb.FallbackController

  alias Teamstory.{Auth.Guardian, Chat, Teams, Users, Utils, Repo}
  alias Teamstory.Chat.Message
  alias Teamstory.Mobile
  alias TeamstoryWeb.Endpoint
  alias Teamstory.Chat.{Attachment, ImageAttachment}
