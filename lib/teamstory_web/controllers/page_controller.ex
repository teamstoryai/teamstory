defmodule TeamstoryWeb.PageController do
  use TeamstoryWeb, :controller
  action_fallback TeamstoryWeb.FallbackController

  def index(conn, _params) do
    render conn, "app.html", layout: {TeamstoryWeb.LayoutView, "landing.html"}, entry: "landing"
  end
  ...
  def health(conn, _) do
    case Teamstory.Repo.db_status do
      :ok -> text conn, "OK"
