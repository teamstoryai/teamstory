defmodule TeamstoryWeb.TeamsController do
  use TeamstoryWeb, :controller
  require Logger

  alias Teamstory.{Auth.Guardian, Teams, Teams.Team, Teams.UserTeam, Users, Users.User,
    Orgs, Utils}
  ...
  def join(conn, %{ "id" => id }) do
    with %User{} = user <- Guardian.Plug.current_resource(conn),
      ...
      TeamstoryWeb.Endpoint.broadcast("user:#{user.uuid}", "update_team", %{})
