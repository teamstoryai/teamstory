defmodule Teamstory.Users do
  @moduledoc """
  The Users context.
  """

  import Ecto.Query, warn: false
  alias Teamstory.{Repo, Utils, Teams.UserTeam}

  alias Teamstory.Users.{User, UserData, MagicLink}
  ...
  def by_uuid!(uuid) do
    Repo.one!(from q in Teamstory.Users.User, where: q.uuid == ^uuid)
  end
  ...
  def magic_link_authenticate(email, code) do
    ...
    cond do
      (Teamstory.dev? || Teamstory.test?) && code == "dev" -> {:ok, user}
  ...
  alias Teamstory.Users.MagicLink
