defmodule Teamstory.Google do
  ...
  def add_profile_email(payload) do
    ...
    {:ok, profile} = Teamstory.Auth.OAuth.get_user_info("google", token)
  ...
  def watch_calendar_events(oauth_token, calendar_id, identifier) do
    params = %{
      "address" => "#{Teamstory.base_url()}/meetings/watch",
      "type" => "web_hook",
      "id" => identifier,
  ...
  def configs, do: Application.get_env(:teamstory, Teamstory.Auth.OAuth)
