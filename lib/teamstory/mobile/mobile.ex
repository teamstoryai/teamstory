defmodule Teamstory.Mobile do
  ...
  alias Teamstory.{Mobile.PushToken, Utils}
  alias Pigeon.{APNS, FCM}

  defp getTopic(type) do
    case type do
      "apn-voip" -> "#{Application.get_env(:teamstory, :bundle_identifier_ios)}.voip"
      "apn" -> Application.get_env(:teamstory, :bundle_identifier_ios)
      "fcm" -> Application.get_env(:teamstory, :bundle_identifier_android)
    end
  end
