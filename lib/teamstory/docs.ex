defmodule Teamstory.Docs do
  @moduledoc """
  The Docs context.
  """

  import Ecto.Query, warn: false
  alias Teamstory.{Projects.Project, Repo}

  alias Teamstory.Docs.{File, Doc}
  ...
  def file_by_uuid(project, uuid) do
    if uuid != nil and uuid != "undefined" and uuid != "" do
      file = Repo.one(from q in File, where: q.project_id == ^project.id and q.uuid == ^Teamstory.Utils.uuid_to_base16(uuid))
  ...
  def doc_by_uuid(project, uuid) do
    if uuid != nil and uuid != "undefined" and uuid != "" do
      doc = Repo.one(from q in Doc, where: q.project_id == ^project.id and q.uuid == ^Teamstory.Utils.uuid_to_base16(uuid))
  ...
  def set_doc_contents(project, uuid, contents) do
    if uuid != nil and uuid != "undefined" and uuid != "" do
      doc = Repo.one(from q in Doc, select: [:id], where: q.project_id == ^project.id and q.uuid == ^Teamstory.Utils.uuid_to_base16(uuid))
      if doc do
        doc
        ...
        create_doc(%{
          uuid: Teamstory.Utils.uuid_to_base16(uuid),
