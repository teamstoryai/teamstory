defmodule Teamstory.Topicflow.JsonRpc do
  ...
  @spec make_request(binary, nil | map) :: Teamstory.Topicflow.JsonRpc.Request.t()
  def make_request(method, params \\ nil) do
    make_request(UUID.uuid1(), method, params)
  end

  @spec make_request(binary, binary, nil | map) :: Teamstory.Topicflow.JsonRpc.Request.t()
  ...
  @spec make_success(binary | Teamstory.Topicflow.JsonRpc.Request.t(), nil | map) ::
          Teamstory.Topicflow.JsonRpc.Success.t()
  ...
  @spec make_error(binary | Teamstory.Topicflow.JsonRpc.Request.t(), number, binary, nil | map) ::
          Teamstory.Topicflow.JsonRpc.Error.t()
  ...
  @spec make_method_not_found_error(binary | Teamstory.Topicflow.JsonRpc.Request.t()) ::
          Teamstory.Topicflow.JsonRpc.Error.t()
  def make_method_not_found_error(request_or_id) do
    make_error(request_or_id, @method_not_found_code, @method_not_found_message)
  end

  @spec make_invalid_params_error(binary | Teamstory.Topicflow.JsonRpc.Request.t()) ::
          Teamstory.Topicflow.JsonRpc.Error.t()
  ...
  @spec encode(
          [
            Teamstory.Topicflow.JsonRpc.Error.t()
            | Teamstory.Topicflow.JsonRpc.Request.t()
            | Teamstory.Topicflow.JsonRpc.Success.t()
          ]
          | Teamstory.Topicflow.JsonRpc.Error.t()
          | Teamstory.Topicflow.JsonRpc.Request.t()
