defmodule Teamstory.Topicflow.Test.MockSocket do
  alias Teamstory.Topicflow.Session
  alias Teamstory.Topicflow.JsonRpc
  ...
  def kill_topic(id) do
    {:ok, pid} = Teamstory.Topicflow.Topic.get_topic_pid(id)
  ...
  def force_conflict(id) do
    ...
    :ok = Teamstory.Topicflow.Topic.cast_test_force_conflict(pid)
    Process.sleep(100)
    :ok
  end
end
