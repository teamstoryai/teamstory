defmodule Teamstory.Topics.UserSettingsTopic do
  alias Teamstory.Topicflow.{Registry, Topic}
  alias Teamstory.Topics.UserSettingsTopic.BackingData

  alias Teamstory.{Users, Users.UserData}

  @topic_identifier "user_settings"

  alias Teamstory.Topics.UserSettingsTopic
  ...
  def retrieve_shared_bulk(%UserSettingsTopic{user_uuid: uuid} = topic) do
    ...
    case Teamstory.Users.find_by_uuid(uuid) do
      {:ok, user} ->
